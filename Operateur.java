...
//                System.out.println("Email sent successfully!");
    ...
    public static void add_Materiel(String typeMarque, String nom_marque, String type_couleur, String serie_marque,
                     javax.swing.JComboBox<String> select, javax.swing.JComboBox<String> select1 ) {
        ...
        try {
            ...
            connection = Utilitaire.getConnection();
            preparedStatement = connection.prepareStatement("INSERT INTO materiel (Marque, typeCouleur, serie, type) VALUES (?, ?, ?, ?)");
            ...
            if (preparedStatement.executeUpdate() > 0) {
                actualiserMaterielsOffice(select);
                actualiserMaterielsGraphique(select1);
    ...
    public static void addUsager(String typePersonne, String nomUsager, String prenomUsager, String cinUsager, String emailUsager, String telephoneUsager, javax.swing.JComboBox<String> select,
    ...
    public static void modifierUsager(long idUsager, String nomUsager, String prenomUsager, String CIN, String email, String tele, String type, javax.swing.JComboBox<String> select,
             javax.swing.JComboBox<String> select1) {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        try {
    ...
    public static void modifierMat(long id, String marque, String serie, String type, String couleur) {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        try {
            connection = Utilitaire.getConnection();
